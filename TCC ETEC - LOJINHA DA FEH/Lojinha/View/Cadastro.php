...
<html lang="iso-8859-1">
  <head>
    ...
    <title>Lojinha da Feh - Cadastro</title>
...
">
    <div class="navbar-header menu" style="height:90px;">
      <a class="navbar-brand fernanda" href="Principal.php" style="color:#DA1E1E;">Lojinha da Feh</a>
            ...
            <div class="cotainer-fluid">
            	<form id="formulario" action="../Actions/cadastrarCliente.action.php" method="post">
                	<ul id="progress">
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="celular2" placeholder="Celular 2">
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="moradia" placeholder="Moradia*"/>
                    ...
                    <fieldset>
                        ...
                        <input type="password" name="csenha" placeholder="Confirmar Senha"/>
                       	...
                       	<input type="button" name="prev" class="prev acao" value="Anterior"/>
                        <button type="submit" name="btEnviar" value="Enviar" class="btn btn-danger"> Enviar Dados </button>
                        </fieldset>
                </form>
