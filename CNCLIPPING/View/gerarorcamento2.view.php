...
<head>
  ...
  <body>
  	...
  	<form style="margin-top: 5%;" action="../Actions/gerar2.action.php" method="post">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Monitoramento</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Monitoramento: Padronizado" name="monitoramento2">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" " name="desc4" maxlength="82">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Cobertura</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Cobertura: Rio de Janeiro – Minas Gerais – Alagoas – Bahia – Pernambuco – Mato Grosso e Goiás. " name="cobertura2">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" " name="desc5" maxlength="82">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Investimento Mensal</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="17.600,00" name="investimento2">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder=" " name="desc6" maxlength="82">
  </div>
