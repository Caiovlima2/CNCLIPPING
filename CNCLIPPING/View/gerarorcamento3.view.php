...
<head>
  ...
  <body>
  	...
  	<form style="margin-top: 5%;" action="../Actions/gerar3.action.php" method="post">
  ...
  <div class="form-group">
   ...
   <p class="h3" style="text-align: center;">Proposta 2</p>

   <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Título</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Clipping de Notícias – Tv: Globo – SBT – Band – Record " name="titulo2">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Monitoramento</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Monitoramento: Padronizado" name="monitoramento2">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder=" " name="desc4" maxlength="82">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Cobertura</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Cobertura: Rio de Janeiro – Minas Gerais – Alagoas – Bahia – Pernambuco – Mato Grosso e Goiás. " name="cobertura2">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder=" " name="desc5" maxlength="82">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Investimento Mensal</label>
    <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="17.600,00" name="investimento2">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control" aria-describedby="emailHelp" placeholder=" " name="desc6" maxlength="82">
  </div>

   <p class="h3" style="text-align: center;">Proposta 3</p>

   <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Título</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Clipping de Notícias – Tv: Globo – SBT – Band – Record " name="titulo3">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Monitoramento</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Monitoramento: Padronizado" name="monitoramento3">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder=" " name="desc7" maxlength="82">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Cobertura</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Cobertura: Rio de Janeiro – Minas Gerais – Alagoas – Bahia – Pernambuco – Mato Grosso e Goiás. " name="cobertura3">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder=" " name="desc8" maxlength="82">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Investimento Mensal</label>
    <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="17.600,00" name="investimento3">
    <label for="exampleInputEmail1" style="margin-left: 1%;">Descrição</label>
    <input type="text" class="form-control" aria-describedby="emailHelp" placeholder=" " name="desc9" maxlength="82">
  </div>
