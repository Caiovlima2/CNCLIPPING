<?php 
	...
	$orc->setTituloIII($_POST['titulo3']);

	$orc->setMonitoramentoIII($_POST['monitoramento3']);

	$orc->setCoberturaIII($_POST['cobertura3']);

	$orc->setInvestimentoIII($_POST['investimento3']);
	...
	$orc->setDesc4($_POST['desc7']);

	$orc->setDesc5($_POST['desc8']);

	$orc->setDesc6($_POST['desc9']);
